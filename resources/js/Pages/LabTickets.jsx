          ...
          <div className="flex justify-between mt-8">
            <table className="w-full border border-collapse border-black">
              ...
              <tbody>
                {/* Example lines */}
                <tr>
                  <td className="px-4 py-2 border border-black text-center">Example Department 1</td>
                  <td className="px-4 py-2 border border-black text-center">04/06/2024</td>
                  <td className="px-4 py-2 border border-black text-center">Example Subject 1</td>
                  <td className="px-4 py-2 border border-black text-center">Assigned To 1</td>
                  <td className="px-4 py-2 border border-black text-center">High</td>
                  <td className="px-4 py-2 border border-black text-center">Open</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 border border-black text-center">Example Department 2</td>
                  <td className="px-4 py-2 border border-black text-center">04/07/2024</td>
                  <td className="px-4 py-2 border border-black text-center">Example Subject 2</td>
                  <td className="px-4 py-2 border border-black text-center">Assigned To 2</td>
                  <td className="px-4 py-2 border border-black text-center">Medium</td>
                  <td className="px-4 py-2 border border-black text-center">Closed</td>
                </tr>
              </tbody>
            </table>
            <div className="ml-8">
